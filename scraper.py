...
def get_supabase():
    # url: str = os.environ.get("https://dadfzgjvqxleqnfzcwqz.supabase.co")
    url = "https://dadfzgjvqxleqnfzcwqz.supabase.co"
    # print(url)
    # key: str = os.environ.get("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRhZGZ6Z2p2cXhsZXFuZnpjd3F6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTIzMTI3NDQsImV4cCI6MjAwNzg4ODc0NH0.2HAf1-LBp4EpAAvT5m0YxL0xi1KcdOp8-U4saJmRHQM")
    key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRhZGZ6Z2p2cXhsZXFuZnpjd3F6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTIzMTI3NDQsImV4cCI6MjAwNzg4ODc0NH0.2HAf1-LBp4EpAAvT5m0YxL0xi1KcdOp8-U4saJmRHQM"
